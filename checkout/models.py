...
class OrderLineItem(models.Model):
    ...
    bottle_size = models.ForeignKey(Size, null=False, blank=False, on_delete=models.CASCADE)
    nicotine = models.ForeignKey(Nicotine, null=False, blank=False, on_delete=models.CASCADE)
